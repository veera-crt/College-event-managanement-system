-- ==========================================
-- CampusHub Centralized Database Schema
-- Optimized for Vercel / PostgreSQL
-- ==========================================

-- 1. DROP TABLES (Ordered for Foreign Key cleanup)
...
-- 6. ATTENDANCE & CERTIFICATES (Dual-Verification System)
...
CREATE TABLE IF NOT EXISTS user_session_history (
    id SERIAL PRIMARY KEY,
    user_id INTEGER REFERENCES users(id) ON DELETE CASCADE,
    action VARCHAR(50) NOT NULL, -- 'login', 'logout', 'refresh'
    ip_address VARCHAR(45),
    user_agent TEXT,
    timestamp TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);

-- 9. FUNCTIONS & AUTOMATION TRIGGERS
